...
func saveActiveUser(userId: Int, userType: String!) {
...
func loginWithUsername(username: String, password: String, hud: MBProgressHUD!) {
    ...
    if ( urlData != nil ) {
        ...
        if (res.statusCode >= 200 && res.statusCode < 300)
        {
            ...
            if(success == 1)
            {
                ...
                saveActiveUser(activeUser.userId, activeUser.userType)
...
func signUpWithFirstName(firstName: String!, lastName: String!, address1: String!, address2: String!, email: String!, password: String!, cPassword: String!, hud: MBProgressHUD!) {
